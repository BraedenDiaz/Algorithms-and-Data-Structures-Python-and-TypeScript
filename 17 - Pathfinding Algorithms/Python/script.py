...
from euclidean_graph import euclidean_graph, bengaluru, jaipur, chennai
...
print("A* Search Example (Euclidean Heuristic):")
a_star(euclidean_graph, bengaluru, jaipur)

print()

print("Another A* Search Example (Euclidean Heuristic)")
